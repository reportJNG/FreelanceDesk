...
export function ProjectCreatePage() {
  ...
  return <><PageHeader title="New Project" description="Connect the project to a client and capture scope, links, stack, and pricing." /><ProjectForm clients={clients.data?.items ?? []} onSubmit={(values) => mutation.mutate(values)} disabled={mutation.isPending} /></>;
}
